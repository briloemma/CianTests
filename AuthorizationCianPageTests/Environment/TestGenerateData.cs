...
{
    internal class TestGenerateData
    {
        ...
        public static string GenerateRandomEmail(string emailDomen, int size = 10)
        {
            string randomEmail = GenerateRandomString(size) + emailDomen;
            return randomEmail;
        }
